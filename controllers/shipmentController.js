    ...
    try {
        ...
        if (serviceId === 1) {
            ...
            const pickrrCreateOrderPayload = {
                ...
                "sender_contact_person_email": "xpressjupiter@gmail.com",
                ...
                "recipient_contact_person_email": "xpressjupiter@gmail.com",
            ...
            const createShipmentRequestBody = {
                ...
                "billing_email": "xpressjupiter@gmail.com",
    ...
    try {
        ...
        if (serviceId == 7){
            ...
            const payload = {
                ...
                "ConsigneeEmail": "xpressjupiter@gmail.com",
                "Instruction": "",
...
const trackShipment = async (req, res) => {
    ...
    const atlanticCourierTracking = async () => {
        try {
            const response = await fetch(`http://cloud.atlanticcourier.net/api/v1/Tracking/Tracking`, {
                method: 'POST',
                headers: {
                    'Content-Type': 'application/json',
                },
                body: JSON.stringify({
                    "UserID": process.env.ATLANTIC_COURIER_USER_ID,
                    "Password": process.env.ATLANTIC_COURIER_PASSWORD,
                    "AWBNo": awb,
                    "Type": "A"
                })
            });
